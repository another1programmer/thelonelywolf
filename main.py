...
FAQ = {
    ...
    "а что смотрим": "🎬 ну что-нибудь посмотрим",
    "а что будем смотреть": "🎬 ну что-нибудь посмотрим",
    "где будем смотреть": "где где, дома у меня",
    "а где собираемся": "где где, дома у меня",
    "а кто организатор": "👤 Организатор — Одинокий волк.",
    "а кто организатор?": "👤 Организатор — Одинокий волк.",
    "когда будем смотреть": "надо подумать, предлагайте",
    "привет": "гамарджоба",
    "привет!": "гамарджоба",
    "как дела": "живой",
    "как дела?": "живой",
